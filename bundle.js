...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tags = __webpack_require__(233);

	var _tags2 = _interopRequireDefault(_tags);

	var _retention = __webpack_require__(234);
	...
	var App = function (_Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function renderView() {
	      if (this.props.activeNav === 'Users') return _react2.default.createElement(_users2.default, null);else if (this.props.activeNav === 'Tags') return _react2.default.createElement(_tags2.default, null);else if (this.props.activeNav === 'Retention') return _react2.default.createElement(_retention2.default, null);
	    }
	  }, {
	    key: 'render',
...
/***/ function(module, exports, __webpack_require__) {
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            { role: 'presentation',
	              ...
	              onClick: function onClick() {
	                _this2.props.onNavClickHandler('Users');
	              } },
	            _react2.default.createElement(
	              'a',
	              { href: '#' },
	          ...
	          _react2.default.createElement(
	            ...
	            { role: 'presentation',
	              ...
	              onClick: function onClick() {
	                _this2.props.onNavClickHandler('Tags');
	              } },
	            _react2.default.createElement(
	              'a',
	              { href: '#' },
	          ...
	          _react2.default.createElement(
	            ...
	            { role: 'presentation',
	              ...
	              onClick: function onClick() {
	                _this2.props.onNavClickHandler('Retention');
	              } },
	            _react2.default.createElement(
	              'a',
	              { href: '#' },
	...
	function mapDispatchToProps(dispatch) {
	  return (0, _redux.bindActionCreators)({ onNavClickHandler: _index.onNavClickHandler }, dispatch);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.onNavClickHandler = exports.NAV_CLICK = exports.getUserData = exports.FETCH_USER_DATA = undefined;
	...
	var FETCH_USER_DATA = exports.FETCH_USER_DATA = 'FETCH_USER_DATA';

	var getUserData = exports.getUserData = function getUserData() {
	  return {
	    type: FETCH_USER_DATA,
	    payload: _axios2.default.get('data/generated.json')
	  };
	};

	var NAV_CLICK = exports.NAV_CLICK = 'NAV_CLICK';

	var onNavClickHandler = exports.onNavClickHandler = function onNavClickHandler(params) {
	  return {
	    type: NAV_CLICK,
	    payload: params
	  };
...
/***/ function(module, exports, __webpack_require__) {
	            ...
	            this.props.userList.filter(function (user) {
	              ...
	              return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  'td',
	                  null,
	                  _react2.default.createElement('img', { src: user.picture, style: { width: 42, height: 42 } })
	                ),
	                _react2.default.createElement(
	                  'td',
	                  null,
	...
	function mapDispatchToProps(dispatch) {
	  return (0, _redux.bindActionCreators)({ getUserData: _index.getUserData }, dispatch);
	}
	...
	var Tags = function (_Component) {
	  ...
	  _createClass(Tags, [{
	    ...
	    value: function getUniqueTags() {
	      var tagList = [];
	      this.props.userList.forEach(function (user) {
	        tagList = tagList.concat(user.tags);
	      });
	      return tagList.filter(function (tag, i, arr) {
	        return arr.indexOf(tag) == i;
	      });
	    }
	  }, {
	    key: 'generateDataForTagTable',
	    value: function generateDataForTagTable() {
	      var _this2 = this;

	      return this.getUniqueTags().map(function (tag) {
	        var allUsersBelongsToCurrentTag = _this2.props.userList.filter(function (user) {
	        ...
	        return {
	          ...
	          sumOfBalance: '$' + allUsersBelongsToCurrentTag.reduce(function (total, user) {
	            return total + parseFloat(user.balance.replace(/[,$]/g, ""));
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'tbody',
	            null,
	            this.generateDataForTagTable().map(function (tagDetails) {
	              return _react2.default.createElement(
	                'tr',
	                { key: tagDetails.tagName },
	                _react2.default.createElement(
	                  'td',
	                  null,
	                  tagDetails.tagName
	                ...
	                _react2.default.createElement(
	                  'td',
	                  null,
	                  tagDetails.totalUsers
	                ),
	                _react2.default.createElement(
	                  'td',
	                  null,
	                  tagDetails.sumOfBalance
	                )
	              );
	            })
	          )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Retention = function (_Component) {
	  _inherits(Retention, _Component);

	  function Retention(props) {
	    _classCallCheck(this, Retention);

	    var _this = _possibleConstructorReturn(this, (Retention.__proto__ || Object.getPrototypeOf(Retention)).call(this, props));
	  ...
	  _createClass(Retention, [{
	    key: 'generateDataForRetention',
	    value: function generateDataForRetention() {
	      return this.props.userList.filter(function (user) {
	        return !user.isActive;
	      }).sort(function (a, b) {
	        a = new Date(a.registered.split('+')[0].trim());
	        b = new Date(b.registered.split('+')[0].trim());
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'div',
	              { className: 'modal-body', style: { wordWrap: 'break-word' } },
	              _react2.default.createElement(
	                'p',
	                null,
	                JSON.stringify(data)
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          this.generateDataForRetention().map(function (user) {
	            return _react2.default.createElement(
	              'li',
	              ...
	              _react2.default.createElement(
	                ...
	                { style: { cursor: 'pointer' },
	                  onClick: function onClick() {
	                    _this3.setState({ selectedUser: user });
	                  }
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Retention);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducer_users = __webpack_require__(236);

	var _reducer_users2 = _interopRequireDefault(_reducer_users);

	var _reducer_active_nav = __webpack_require__(237);

	var _reducer_active_nav2 = _interopRequireDefault(_reducer_active_nav);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var rootReducer = (0, _redux.combineReducers)({
	  userList: _reducer_users2.default,
	  activeNav: _reducer_active_nav2.default
	});
